...
## App at work
Open the [iMage](https://github.com/shangfii/Employee_Manager/blob/main/iMages/EmployeeManager.mov) in the Image folder above  to see the app at work just incase the image bellow is slow for you
